...
Public Class Laporan_Penjualan
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Dim GambarBitMap As New Bitmap(Me.dgvLaporanPenjualan.Width, Me.dgvLaporanPenjualan.Height)
        dgvLaporanPenjualan.DrawToBitmap(GambarBitMap, New Rectangle(0, 0, Me.dgvLaporanPenjualan.Width, Me.dgvLaporanPenjualan.Height))
        e.Graphics.DrawImage(GambarBitMap, 50, 10)
    End Sub
End Class
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Panel9.Size = New Size(400, 500)
        Panel9.Location = New Point(Me.Width - 400, 70)
...
", fontKetentuan, Brushes.Black, rect.Left + 100, rect.Top + 485)
        ...
        e.Graphics.DrawString(("Kartu ini dicetak pada " + Format(Now, "dd-MM-yyyy HH:mm:ss")), fontTanggal, Brushes.Black, rect.Left + 100, rect.Top + 5)
    End Sub
    ...
    Private Sub tbNIK_KeyDown(sender As Object, e As KeyEventArgs) Handles tbNIK.KeyDown
    ...
    Private Sub tbNamaLengkap_KeyDown(sender As Object, e As KeyEventArgs) Handles tbNamaLengkap.KeyDown
        If e.KeyCode = Keys.Down Then
    ...
    Private Sub dtpTanggalLahir_KeyDown(sender As Object, e As KeyEventArgs) Handles dtpTanggalLahir.KeyDown
        If e.KeyCode = Keys.Down Then
            cbProvinsiAlamat.Focus()
        ElseIf e.KeyCode = Keys.Up Then
            tbNamaLengkap.Focus()
    ...
    Private Sub cbProvinsiAlamat_KeyDown(sender As Object, e As KeyEventArgs) Handles cbProvinsiAlamat.KeyDown
        If e.KeyCode = Keys.Enter Then
            cbKotaAlamat.Focus()
        End If
    End Sub

    Private Sub cbKotaAlamat_KeyDown(sender As Object, e As KeyEventArgs) Handles cbKotaAlamat.KeyDown
        If e.KeyCode = Keys.Enter Then
            cbKecamatan.Focus()
        End If
    End Sub

    Private Sub cbKecamatan_KeyDown(sender As Object, e As KeyEventArgs) Handles cbKecamatan.KeyDown
        If e.KeyCode = Keys.Enter Then
            cbKelurahan.Focus()
        End If
    End Sub

    Private Sub cbKelurahan_KeyDown(sender As Object, e As KeyEventArgs) Handles cbKelurahan.KeyDown
        If e.KeyCode = Keys.Enter Then
            tbNamaJalan.Focus()
        End If
    End Sub

    Private Sub tbNamaJalan_KeyDown(sender As Object, e As KeyEventArgs) Handles tbNamaJalan.KeyDown
        If e.KeyCode = Keys.Down Then
            cbFaskes.Focus()
        ElseIf e.KeyCode = Keys.Up Then
            cbKelurahan.Focus()
    ...
    Private Sub cbFaskes_KeyDown(sender As Object, e As KeyEventArgs) Handles cbFaskes.KeyDown
        If e.KeyCode = Keys.Enter Then
            If tbNIK.Text = "" Or tbNIK.TextLength < 16 Then
                MessageBox.Show("Data NIK Belum Lengkap !!!", "GAGAL", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                tbNIK.Focus()
    ...
    Private Sub Timer4_Tick(sender As Object, e As EventArgs) Handles Timer4.Tick
        ...
        labelWaktu.Location = New Point(Panel9.Width - labelWaktu.Width, 0)
        labelTime.Text = Format(Now, "HH:mm:ss")
        labelTime.Location = New Point(Panel9.Width - labelTime.Width, 40)
    End Sub
End Class

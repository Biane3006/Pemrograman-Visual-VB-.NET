...
Public Class Laporan_Pembelian
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Dim GambarBitMap As New Bitmap(Me.dgvLaporanPembelian.Width, Me.dgvLaporanPembelian.Height)
        dgvLaporanPembelian.DrawToBitmap(GambarBitMap, New Rectangle(0, 0, Me.dgvLaporanPembelian.Width, Me.dgvLaporanPembelian.Height))
